<?php 
    Class Product extends CI_Model{
        public function get_all_product_list($limit, $offset){
            return $this->db->query("SELECT main_image_url, id, name, price, onhand as inventory_count, sold as qty_sold FROM products limit ? OFFSET ?", array($limit, $offset))->result_array();
        }
